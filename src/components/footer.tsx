    ...
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-4 p-3 bg-[url('/footer-lbg.png')] bg-left bg-cover bg-no-repeat rounded-xl flex flex-col">
            ...
            <div className="flex justify-center gap-4">
              ...
              >
                ...
                >
                  <path
                    d="M12.4146 0C5.57115 0 0.000146087 5.57101 0.000146087 12.4145C-0.0464083 22.4082 11.049 30.4155 11.5146 30.7569C11.7784 30.9431 12.1043 31.0518 12.4146 31.0518C12.725 31.0518 13.0509 30.9587 13.3147 30.7569C13.7802 30.4155 24.8757 22.4237 24.8291 12.4145C24.8291 5.57101 19.2581 0 12.4146 0ZM12.4146 18.6217C8.98514 18.6217 6.2074 15.844 6.2074 12.4145C6.2074 8.98499 8.98514 6.20725 12.4146 6.20725C15.8441 6.20725 18.6219 8.98499 18.6219 12.4145C18.6219 15.844 15.8441 18.6217 12.4146 18.6217Z"
                    fill="white"
                  />
                </svg>
              </a>
          ...
          <div className="md:col-span-2 md:block hidden">
            ...
            <ul className="space-y-1 md:space-y-0 lg:space-y-2">
              {[
                ...
                { name: "Imaging", link: "#imaging" },
                { name: "Informed Care", link: "#informed" },
                { name: "Second Opinion", link: "#opinion" },
          ...
          <div className="md:col-span-2 md:block hidden">
            ...
            <ul className="space-y-1 lg:space-y-2">
              {["PET / CT Scan", "Chemotherapy", "Radiotherapy"].map(
                (service) => (
                  <li key={service}>
                    <a
                      href="#services"
          ...
          <div className="md:col-span-4">
            <div className="relative h-48 md:h-64 rounded-lg overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3606.84421775294!2d55.5697656!3d25.309437499999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ef5f57224798acf%3A0xad0d63c2c80585f6!2sSharjah%20Healthcare%20city!5e0!3m2!1sen!2s!4v1776080065911!5m2!1sen!2s"
                width="400"
                height="300"
                style={{ border: 0 }}
      ...
      <div className="max-w-7xl mx-auto pb-6 md:pb-8">
        <p className="text-black text-xs md:text-sm text-center">
          Copyright © {currentYear} Advanced Diagnostic & Oncology Centre
        </p>
      </div>
    </footer>
  );
