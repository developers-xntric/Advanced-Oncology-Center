      ...
      <div className="mx-auto max-w-[1440px] w-[90%]">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="space-y-3 w-full md:w-[40%]">
            ...
            <h2 className="-mb-2 md:mb-3 text-center md:text-left text-[24px] sm:text-[28px] lg:text-[40px] font-medium bg-gradient-to-b from-[#005f56] to-[#009788] bg-clip-text text-transparent leading-tight md:leading-none ">
              Dedicated to Comprehensive Cancer Care
            </h2>
          </div>

          {/* Paragraphs */}
          <div className="text-center md:text-left text-sm sm:text-base text-[#333] 2xl:text-lg w-full md:w-[60%] space-y-3 md:space-y-2">
            <p>
