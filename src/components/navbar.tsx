        ...
        <div className="flex justify-between items-center">
          ...
          <div className="shrink-0 flex items-center">
            <Image
              ...
              width={2000}
              height={2000}
              className="h-8 md:h-10  w-auto  relative -left-5 md:-left-7"
              priority
            />
          </div>
          ...
          <div className="hidden xl:flex items-center gap-6 justify-center">
            ...
            <div className="hidden md:flex items-center ml-4">
              <Link
                ...
                className="bg-[#004445] cursor-pointer bg-cover bg-no-repeat text-white px-4 py-4 rounded-lg flex items-center gap-2 transition-colors duration-200 font-medium"
              >
                <Contact />
              </Link>
            </div>
