      ...
      <div className="relative z-10 mx-auto  w-[90%]">
        <div className="flex items-center justify-between gap-28">
          ...
          <div className="flex flex-col justify-center w-[50%]">
            ...
            {/* Main heading */}
            <h2 className="mb-4 text-3xl font-medium leading-tight text-white md:text-4xl 2xl:text-5xl">
              Precision Diagnostics. Clearer Insights. Better Care.
            </h2>

            {/* Description */}
            <p className="text-base leading-relaxed text-white/80 2xl:text-lg">
